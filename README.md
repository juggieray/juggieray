...
- Diagnosed and resolved complex issues across the Meraki product line, including wireless access points, security appliances, switches, and IoT devices.
- Provided professional troubleshooting solutions in IP networking, L2/L3 network protocols, and secure transport methods.
- Worked closely with a team of software engineers to implement "the vWAN," ensuring seamless failover between Meraki appliance uplinks.

### Software Engineer Intern (Backend) • IBM (Jun 2022 - Aug 2022)
- Collaborated on a scalable web application aimed at poverty prevention, leveraging IBM's Cloud Computing, Kubernetes, and Docker.
- Deployed intelligent back-end solutions using IBM Cloud and Watson Assistant.
...
- Led the design and development of a custom drone attachment using a Raspberry Pi 5, enhancing drone functionality.
- Integrated advanced embedded systems, real-time data processing, and multi-threaded Python scripting.

### Theta Tau SpacePark • San José State University (Mar 2022 - May 2022)
- Directed the hardware sub-team to develop an embedded systems device for tracking car occupancy in a garage.
- Integrated hardware components and developed firmware to interact with Google Firebase API.

## 🔧 Skills

**Programming Languages:** [![My Skills](https://skillicons.dev/icons?i=java,js,c,cpp,html,css,mysql)](https://skillicons.dev)  
